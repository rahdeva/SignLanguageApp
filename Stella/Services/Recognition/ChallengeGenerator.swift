...
struct ChallengeGenerator {
    ...
    static let weightedWords: [WeightedWord] = [
        WeightedWord(word: "Datang", f1Score: 0.90),
        WeightedWord(word: "Dengar", f1Score: 0.89),
        WeightedWord(word: "Motor", f1Score: 0.88),
        WeightedWord(word: "Terima kasih", f1Score: 0.86),
        WeightedWord(word: "Saya", f1Score: 0.84),
        WeightedWord(word: "Belajar", f1Score: 0.82),
        WeightedWord(word: "Maaf", f1Score: 0.78),
        WeightedWord(word: "Keluarga", f1Score: 0.76),
        WeightedWord(word: "Mengapa", f1Score: 0.59),
        WeightedWord(word: "Lagi", f1Score: 0.56),
        WeightedWord(word: "Kapan", f1Score: 0.53),
        WeightedWord(word: "Apa", f1Score: 0.49),
        WeightedWord(word: "Berangkat", f1Score: 0.39),
        WeightedWord(word: "Teman", f1Score: 0.38),
        WeightedWord(word: "Siang", f1Score: 0.37),
        WeightedWord(word: "Merah", f1Score: 0.35),
        WeightedWord(word: "Tuli", f1Score: 0.34),
        WeightedWord(word: "Air", f1Score: 0.33),
        WeightedWord(word: "Kuning", f1Score: 0.31),
        WeightedWord(word: "Rumah", f1Score: 0.30),
        WeightedWord(word: "Hitam", f1Score: 0.29),
        WeightedWord(word: "Bagaimana", f1Score: 0.28),
        WeightedWord(word: "Di mana", f1Score: 0.27),
        WeightedWord(word: "Ingat", f1Score: 0.24),
        WeightedWord(word: "Siapa", f1Score: 0.22),
        WeightedWord(word: "Makan", f1Score: 0.20),
        WeightedWord(word: "Cari", f1Score: 0.18),
        WeightedWord(word: "Pagi", f1Score: 0.17),
        WeightedWord(word: "Malam", f1Score: 0.16),
        WeightedWord(word: "Sore", f1Score: 0.15),
        WeightedWord(word: "Hari", f1Score: 0.13),
        WeightedWord(word: "Hijau", f1Score: 0.10)
    ]
